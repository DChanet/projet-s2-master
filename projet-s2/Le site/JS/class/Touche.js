class Touche {
    ...
    constructor(numero){
        ...
        if(numero <= 3){
            this.pastille = new Pastille("bas", 6, this.button.x, this.button.y, this.button.width, this.button.height);
        }else if(numero == 4){
            this.pastille = new Pastille("droite", 6, this.button.x, this.button.y, this.button.width, this.button.height);
        }else if(numero == 6){
            this.pastille = new Pastille("gauche", 6, this.button.x, this.button.y, this.button.width, this.button.height);
        }else if(numero == 5){
            this.pastille = new Pastille("centre", 6, this.button.x, this.button.y, this.button.width, this.button.height);
        }else{
            this.pastille = new Pastille("haut", 6, this.button.x, this.button.y, this.button.width, this.button.height);
        }
    }
